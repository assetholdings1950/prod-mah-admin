...
const RISK_OPTIONS: DropdownOption[] = [
    { label: "Conservative", value: "conservative", dot: "bg-emerald-400" },
    { label: "Moderate", value: "moderate", dot: "bg-amber-400" },
    { label: "Aggressive", value: "aggressive", dot: "bg-red-400" },
];
...
const ClientToolbar: React.FC<ClientToolbarProps> = ({
    ...
    const activeCount = [statusFilter, kycFilter, riskFilter, countryFilter, currencyFilter].filter(
        (v) => v && v !== "all"
    ).length;
