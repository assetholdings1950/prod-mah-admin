...
import { Field, ImageThumbnail, ReadonlyField, SectionHeading, inputCls } from "./primitives";
import { FormState, SetFormField } from "./types";

interface Props {
    form: FormState;
    set: SetFormField;
    kyc: IClients["kycVerification"];
        ...
        <div>
            ...
            <Field label="Remarks / Review Notes">
                <textarea
                    ...
                    placeholder="Add remarks about this client's KYC submission..."
                />
            </Field>
        </div>
