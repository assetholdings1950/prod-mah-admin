                ...
                <div className="relative bg-white rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.12)] border border-slate-100 overflow-hidden">
                    ...
                    <div className="flex items-start gap-3 px-4 pt-4 pb-3.5">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-[13px] font-semibold text-slate-800 leading-snug font-jost">
                                {message}
                            </p>
                            {options?.description && (
                                <p className="text-[12px] text-slate-500 mt-0.5 leading-relaxed font-jost">
                                    {options.description}
                                </p>
                            )}
                        </div>
                    ...
                    <div className="flex items-center gap-1.5 px-4 pb-2.5">
                        ...
                        <span className="text-[10px] uppercase tracking-[0.1em] text-slate-400 font-medium font-jost">
                            {type}
                        </span>
                    </div>
                </div>
