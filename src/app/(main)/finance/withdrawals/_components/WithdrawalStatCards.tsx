...
function CountCard({ label, value, sub, accentClass, loading }: {
...
function CurrencyVolumeCard({ currency, total, count, loading }: {
...
export default function WithdrawalStatCards({ summary, loading }: Props) {
